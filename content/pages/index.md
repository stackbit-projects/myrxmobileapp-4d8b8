...
sections:
  - type: hero_section
    title: Your personal medical device
    ...
    content: >
      ...
      enjoy same benefits while away from your healthcare provider.
    actions:
      - label: App Store
        url: /pricing
        style: primary
  ...
  - type: grid_section
    ...
    grid_items:
      - title: Device Information
        title_align: left
        content: >
          asgfacgd ahvsdva vasv vhah adhsdvj vbhajdjbb bjhas hjba hbvajd havsj
          vbhasvj hbajd vha hvahjd hvbjhs hvbjhd bjsbc bjsd vbhs hgv.
        content_align: left
        actions:
          - label: Learn More
            url: /style-guide
